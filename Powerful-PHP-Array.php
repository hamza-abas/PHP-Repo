...
// use the ternary operator to check if the page  param is set
$page = (isset($_GET['page'])) ? (int) $_GET['page'] : 0;
$prev = ($page==0) ? 0 : $page - 1;
$next = ($page==21) ? 21 : $page + 1;
$linesPerpage = 3;



function displayproduct ($page, $linesPerpage , $maxProducts , $products) 
	...
	<div class="product-list">
		...
		<a class="pages" href="products.php?page=<?php echo $next; ?>">next&gt;</a>
			<ul>
				...
				<?php echo displayproduct ($page, $linesPerpage , $maxProducts , $products); ?>
		</ul>
	</div><!-- product-list -->
